...
<body>
    ...
    <section>
        <div class="container">
            <a type="submit" class="btn btn-danger btn-lg " href="../roles/cajero.php" value="ok" ><i class="fa-solid fa-arrow-left"></i></a>
            <form class="p-4 m-auto" method="POST">
                <h3 class="text-center alert alert-primary">VERDER PRODUCTO</h3>
                ...
                while ($datos = $sql->fetch_object()) { ?>
                    ...
                    <div class="mb-1">
                        ...
                        <input type="number" class="form-control" name="cantidad" id="cantidad" value="<?= $datos->Cantidad ?>" disabled>
                    </div>
                    <div class="mb-1">
                        <label for="exampleInputEmail1" class="form-label">Cantidad a vender</label>
                        <input type="number" required min="1" class="form-control" name="cantidadD" id="cantidadD" value="" placeholder="Ingresa La cantidad..." oninput="validarCantidad()">
                    </div>
                    <div class="mb-1">
                        <label for="exampleInputEmail1" class="form-label">Precio</label>
                        <input type="number" class="form-control" name="precio" id="precio" value="<?= $datos->Precio ?>" disabled>
                    </div>
                    <div class="mb-1">
                        <label for="exampleInputEmail1" class="form-label">Descripcion</label>
                        <input type="text" class="form-control" name="descrip" value="<?= $datos->Descripcion ?>" disabled>
                    </div>
                <?php }
                ?>
                <button type="submit" class="btn btn-primary btn-lg m-1" name="btnregistrar" value="ok">VENDER</button>
                <a type="submit" class="btn btn-danger btn-lg m-1" href="../roles/cajero.php" value="ok">CANCELAR</a>
            </form>
        </div>
    </section>
