...
<body>
        ...
        <section>
                <div class="container">
                        <a type="submit" class="btn btn-danger btn-lg " href="../cajero.php" value="ok"><i class="fa-solid fa-arrow-left"></i></a>
                        <form class="p-4 m-auto" method="POST">
                                <h3 class="text-center alert alert-secondary">MODIFICACION</h3>
                                ...
                                while ($datos = $sql->fetch_object()) { ?>
                                        ...
                                        <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" name="marca" value="<?= $datos->Nombre_de_Marca ?>">
                                        </div>
                                        <div class="mb-1">
                                                <label for="exampleInputEmail1" class="form-label">Cantidad</label>
                                                <input type="int" class="form-control" name="cantidad" value="<?= $datos->Cantidad ?>">
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <div class="mb-1">
                                                ...
                                                <input type="int" class="form-control" name="descrip" value="<?= $datos->Descripcion ?>">
                                        </div>
