        ...
        <section>
                <div class="container">
                        ...
                        <form class="p-4 m-auto" method="POST">
                                <h3 class="text-center alert alert-primary" >MODIFICACIÓN</h3>
                                ...
                                while ($datos = $sql->fetch_object()) { ?>
                                        <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" required name="nombre" value="<?= $datos->Nombre ?>">
                                        </div>
                                        <div class="mb-1">
                                                <label for="exampleInputEmail1" class="form-label">Marca</label>
                                                <input type="text" class="form-control" required name="marca" value="<?= $datos->Nombre_de_Marca ?>">
                                        </div>
                                        <div class="mb-1">
                                                <label for="exampleInputEmail1" class="form-label">Cantidad</label>
                                                <input type="number" class="form-control" required min="1" name="cantidad" value="<?= $datos->Cantidad ?>">
                                        </div>
                                        <div class="mb-1">
                                                <label for="exampleInputEmail1" class="form-label">Precio</label>
                                                <input type="number" class="form-control" required min="1" name="precio" value="<?= $datos->Precio ?>">
                                        </div>
                                        <div class="mb-1">
                                                <label for="exampleInputEmail1" class="form-label">Descripcion</label>
                                                <input type="int" class="form-control" required name="descrip" value="<?= $datos->Descripcion ?>">
                                        </div>
                                ...
                                <button type="submit" class="btn btn-primary btn-lg m-1" name="btnregistrar" value="ok">MODIFICAR</button>
